        ...
        <div class="bg-image" style="
            ...
            <div class="container" style="">
                <main role="main" class="container my-auto">
                    <div class="row">
                        <img class="img-fluid mx-auto d-block rounded" width="20" height="20" src="https://cdn-icons-png.flaticon.com/512/1998/1998575.png" />
                            <br>
                        <form action="NewData.jsp" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for='AccountInfo.make'>Make</label>
                                    <input '" resultset.getString("carmake") "' name='AccountInfo.make' type='text' class='form-control' id='AccountInfo.make'>
                                </div>
                                <div class="form-group">
                                     <label for='AccountInfo.model'>Model</label>
                                    <input ' resultSet.getString("carmodel") ' name='AccountInfo.model' type='text' class='form-control' id='AccountInfo.model'>
                                </div>
                                <div class="form-group">
                                    <label for='AccountInfo.year'>Year</label>
                                    <input ' resultSet.getInt("caryear") + ' name='AccountInfo.year' type='number' class='form-control' id='AccountInfo.year'>
                                </div>
                                <div class="form-group">
                                    <label for='AccountInfo.price'>Price</label>
                                    <input ' resultSet.getInt("carprice") ' name='AccountInfo.price' type='number' class='form-control' id='AccountInfo.price'>                            
                                </div>
